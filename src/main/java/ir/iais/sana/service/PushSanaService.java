...
@WebServiceClient(name = "PushSanaService",
                  wsdlLocation = "http://services.ecogif.ir/ESB/rest/services/desc/PushSana/4_0?wsdl",
...
public class PushSanaService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://services.ecogif.ir/ESB/rest/services/desc/PushSana/4_0?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PushSanaService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://services.ecogif.ir/ESB/rest/services/desc/PushSana/4_0?wsdl");
        }
        WSDL_LOCATION = url;
    }
